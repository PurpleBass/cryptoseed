    ...
    <div className="container mx-auto p-4 max-w-4xl">
      <div className="mb-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-bold">Verify Our Code</h2>
        </div>
      ...
      <Alert className="mb-6 bg-secure-100 text-secure-800 border-secure-300">
        ...
        <AlertDescription>
          ...
          The core encryption logic is in <code>src/lib/encryption.ts</code>
        </AlertDescription>
      </Alert>
      ...
      <Tabs defaultValue="encryption">
        ...
        <TabsContent value="encryption">
          <Card>
            <CardHeader>
              <CardTitle>Core Encryption Implementation</CardTitle>
              <CardDescription>
  ...
  try {
    ...
    throw new Error("Failed to decrypt message");
              ...
              <div className="p-4 bg-muted rounded-md overflow-auto max-h-[600px]">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 mt-2 space-y-2">
                      <li>
                        <code>src/lib/encryption.ts</code> - Core encryption/decryption logic
                      </li>
                      <li>
                        <code>src/components/EncryptionComponent.tsx</code> - User interface for 
                        encryption/decryption
                      </li>
                      <li>
                        <code>src/pages/Index.tsx</code> - Main application page
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <TabsContent value="verify">
          <Card>
            <CardHeader>
              <CardTitle>How to Verify Our Code</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium">View Source in Browser</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium">Check Network Activity</h3>
                  <p className="mt-2 text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium">Clone the GitHub Repository</h3>
                  <p className="mt-2 text-muted-foreground">
                ...
                <div>
                  <h3 className="text-lg font-medium">Offline Usage</h3>
                  <p className="mt-2 text-muted-foreground">
