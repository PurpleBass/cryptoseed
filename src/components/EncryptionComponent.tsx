  ...
  return <div className="satoshi-container py-10 bg-white">
      ...
      <Tabs defaultValue="seedphrase" value={mode} onValueChange={v => setMode(v as "seedphrase" | "text" | "file")} className="mt-4">
        <TabsList className="mb-4 rounded-full bg-white p-1 border border-gray-100 shadow-sm">
          ...
          <TabsTrigger value="file" className="rounded-full data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:shadow-sm">
            File
          </TabsTrigger>
        </TabsList>
            ...
            <CardContent>
              <div className="grid gap-6">
                <div className="grid gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Input 
                      ...
                      className="satoshi-input text-sm text-gray-600 file:mr-4 file:rounded-md file:border-0 file:bg-secure-50 file:px-4 file:py-2 file:text-sm file:font-medium hover:file:bg-secure-100" 
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <Input id="filePassword" type={showPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="Enter a strong password" className="satoshi-input pr-10" />
                    <Button type="button" variant="ghost" size="icon" onClick={togglePasswordVisibility} className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8">
                      {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                    </Button>
                  </div>
