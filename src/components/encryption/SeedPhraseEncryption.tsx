            ...
            {isEncrypting ? (
              ...
              <div className="grid gap-2">
                ...
                <textarea
                  ...
                  className="min-h-32 satoshi-input w-full rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-sm placeholder:text-gray-500 placeholder:font-helvetica"
                />
              </div>
            )}
