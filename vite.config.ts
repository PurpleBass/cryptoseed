...
import { generateNonce } from "./src/lib/cspReport";

// https://vitejs.dev/config/
export default defineConfig(({ mode }) => {
  // Generate nonces for this server session
    ...
    server: {
      ...
      headers: {
        ...
        'Content-Security-Policy': `
          default-src 'self';
          script-src 'self' 'strict-dynamic' 'nonce-${scriptNonce}' https://cdn.gpteng.co;
